            ...
            <div className="px-8 pb-8">
              ...
              {step === 1 && (
                <>
                  ...
                  <button className="w-full mt-4 flex items-center justify-center gap-3 py-3.5 rounded-xl border-2 border-outline-variant/40 bg-surface-container-lowest hover:bg-surface-container-low transition-all font-medium text-on-surface text-sm">
