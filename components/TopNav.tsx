...
export default function TopNav() {
  ...
  return (
    <header className="fixed top-0 w-full z-50 flex justify-between items-center px-4 md:px-6 h-16 bg-surface-container-lowest/90 backdrop-blur-md shadow-sm border-b border-outline-variant/20">
      ...
      <div className="flex items-center gap-2 md:gap-3">
        ...
        <div className="hidden md:flex flex-col items-end mr-1">
          <span className="text-sm font-bold text-on-surface font-headline leading-tight">
            Arif Ahmed
          </span>
        ...
        <div className="flex items-center gap-2 bg-primary-fixed/20 px-2 py-1 rounded-full border border-primary-fixed/30 cursor-pointer hover:bg-primary-fixed/30 transition-colors">
          <img
