    ...
    <header className="fixed top-0 w-full z-50 flex justify-between items-center px-4 md:px-6 h-16
      ...
      <div className="flex items-center gap-2 md:gap-3">
        ...
        <div className="hidden md:flex flex-col items-end mr-1">
          <span className="text-sm font-bold text-on-surface font-headline leading-tight">Arif Ahmed</span>
          <span className="text-[10px] uppercase tracking-widest text-on-surface-variant font-label">অভিভাবক</span>
        </div>

        <Link
          href="/dashboard/notifications"
          className="p-2 rounded-full hover:bg-surface-container dark:hover:bg-green-900/20 transition-colors relative"
        >
        ...
        <div className="flex items-center gap-2 bg-primary/10 dark:bg-primary/15 px-2 py-1 rounded-full border border-primary/20 cursor-pointer hover:bg-primary/20 transition-colors">
          ...
          />
          <span className="text-sm font-semibold text-on-surface hidden sm:inline">Tanvir</span>
