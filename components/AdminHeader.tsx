...
export default function AdminHeader({ title, breadcrumb, actions }: AdminHeaderProps) {
  ...
  return (
    <header className="bg-white/90 backdrop-blur-xl w-full h-16 sticky top-0 z-40 shadow-sm border-b border-outline-variant/10 flex items-center gap-3 px-4 md:px-6">
