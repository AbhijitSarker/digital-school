...
export default function AdminSidebar({ isOpen, onClose }: AdminSidebarProps) {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside
        className={`bg-emerald-900 text-emerald-50 h-screen w-72 lg:w-64 fixed left-0 top-0 overflow-y-auto shadow-2xl z-50 flex flex-col p-4 transition-transform duration-300 ease-in-out
      ...
      >
        ...
        <div className="mt-2 flex items-center gap-3 px-2 py-3 rounded-xl bg-white/5 border border-white/10">
          <div className="w-9 h-9 rounded-full bg-primary-fixed/30 border border-primary-fixed flex items-center justify-center font-bold text-white text-sm font-headline shrink-0">
            আ
          </div>
          <div className="flex-1 min-w-0">
